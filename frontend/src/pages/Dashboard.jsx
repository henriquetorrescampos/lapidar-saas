  ...
  return (
    <Layout>
      <div>
        ...
        <div className="mt-8">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Guia de Emissão de Guias</h2>

          {/* IPASGO */}
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">IPASGO</span>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">IAMESC</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
            <Card>
              <p className="text-sm text-gray-400 italic">Informações sobre emissão de guias IAMESC serão adicionadas em breve.</p>
            </Card>
          </div>
